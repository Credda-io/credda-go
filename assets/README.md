...
live in this repository for that URL to exist. They add roughly 113 KB to the module zip, which is the whole cost of the
header resolving everywhere it is read.
